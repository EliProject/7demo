...
public class MusicPlayService extends Service
     ...
     * 删除通知
     */
    public final static int BUTTON_NOFICY_ID = 10;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.hasExtra(MUSIC_KEY)) {//播放歌曲或者切换歌曲的时候
            ...
            if (bundle != null) {
                values = bundle.getBoolean(MUSIC_UPDATE_KEY);
                sSelectedItem = bundle.getInt(MUSIC_UPDATE_ITEM_KEY);
                Log.i(TAG," sSelectedItem="+sSelectedItem+" values="+values);
            }
            addOnActiveSessionsChangedListener(values);
        }
            ...
            if (action.equals(ACTION_CLICK)) {
                ...
                switch (buttonId) {
                    ...
                    case BUTTON_DELETE_NOFICY_ID:
                        ...
                        break;
                    case BUTTON_NOFICY_ID:
                        Log.i(TAG, "BUTTON_NOFICY_ID.....");
                    default:
